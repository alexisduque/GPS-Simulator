...
import gps.simulator.modele.NomadicMax;
...
public class GPSimulatorGUI extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                gpsModel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nomadic", "NomadixMaxi", "TK-102" }));
                gpsModel.addItemListener(new java.awt.event.ItemListener() {
                        public void itemStateChanged(java.awt.event.ItemEvent evt) {
                                gpsModelItemStateChanged(evt);
                        }
                });
                gpsModel.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                gpsModelActionPerformed(evt);
                        }
                });
        ...
        int imei = 0000000003;// + rand.nextInt(1000);
            ...
            switch (gpsModel.getSelectedIndex()) {
                case 0:
                    ...
                    break;
                case 1:
                    gpsTracker = new NomadicMax(ip, port, per, imei, fileT, this);
                    break;
                case 2:
    ...
    private void sendPeriodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendPeriodActionPerformed
        ...
        private void gpsModelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gpsModelActionPerformed
                // TODO add your handling code here:
        }//GEN-LAST:event_gpsModelActionPerformed
